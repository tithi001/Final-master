...
public class WelcomeActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{R.layout.slider_1, R.layout.slider_2, R.layout.slider_3, R.layout.slider_4, R.layout.slider_5, R.layout.slider_6, R.layout.slider_7, R.layout.slider_8, R.layout.slider_9, R.layout.slider_10, R.layout.slider_11};
